...
function beaker2(speak){
    console.log(`${speak} `.repeat(4));
}
beaker2('Meep');  // Meep Meep Meep Meep 
...
//* No, if it is within a function, it must be ran inside of the function ect. 
...
randomMuppet(charactersOne);  // Waldorf
randomMuppet(charactersTwo);  // Animal
